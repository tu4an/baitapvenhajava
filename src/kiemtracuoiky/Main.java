...
public class Main {
	...
	//thực phẩm
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_01", "rau cu", 2500, 50, LocalDate.parse("01/01/2013", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_02", "ca", 1500, 15, LocalDate.parse("02/02/2013", formatter)));
		H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_03", "thuc an nhanh", 2000, 60, LocalDate.parse("03/03/2013", formatter)));
        H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_04", "trai cay", 2000, 60, LocalDate.parse("03/03/2012", formatter)));
        H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_05", "banh ngot", 2000, 60, LocalDate.parse("01/02/2013", formatter)));
        H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_06", " banh man ", 2000, 60, LocalDate.parse("01/03/2013", formatter)));
        H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_07", " thit ga ", 2000, 60, LocalDate.parse("02/03/2013", formatter)));
        H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_08", " thit bo ", 2000, 60, LocalDate.parse("04/05/2012", formatter)));
        H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_09", " thit heo ", 2000, 60, LocalDate.parse("02/06/2012", formatter)));
	...
	//sành sứ
        ...
        H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_05", "dia", 7000, 12, LocalDate.parse("06/06/2016", formatter)));
        H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_06", "to", 7000, 12, LocalDate.parse("06/06/2016", formatter)));
	...
	//đồ điện
        ...
        H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_04", "may lanh", 5500000, 120, LocalDate.parse("09/12/2019", formatter)));
        H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_05", "den dien", 35000, 120, LocalDate.parse("09/08/2019", formatter)));
        H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_06", "tu dong", 3500000, 120, LocalDate.parse("10/08/2020", formatter)));
	}
